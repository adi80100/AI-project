...
const Nav = () => {
    ...
    return (
        ...
        <>
        {selectedConversation &&  <div className='h-14 flex items-center gap-2.5 justify-between px-5 border-b border-white/[0.06] bg-[#0d0f14]'>
      <div className='flex items-center justify-center w-9 h-9 rounded-lg  bg-indigo-500/10 border border-indigo-500/20'>
        <MessageSquare size={20} className='text-indigo-400'/>
      </div >
      <div className='text-14 font-semibold text-slate-100 tracking tight' >
